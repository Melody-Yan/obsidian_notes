...
var CMD_CONFIG_ARR = config2Arr(CMD_CONFIG);
  ...
  constructor(props) {
    ...
    this.search = function(str) {
      ...
      if (!str) {
        ...
        _cmds = import_fuzzy.default.filter(str || "", CMD_CONFIG_ARR, { extract: (e) => e.title }).map((e) => e.original.cmd).filter((e) => HEADING_MENU.includes(e));
      }
      this.generateMenu(_cmds);
    };
    this.generateMenu = function(_cmds) {
      if (_cmds.length === 0) {
        this.hide();
      }
      ...
      setTimeout(() => {
        var _a, _b, _c;
        (_c = (_b = (_a = this.menu.children) == null ? void 0 : _a[0]) == null ? void 0 : _b.focus) == null ? void 0 : _c.call(_b);
      });
...
var ExampleSettingTab = class extends import_obsidian4.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian4.Setting(containerEl).setName("Selection Options").setDesc("Display shortcut options after selecting text").addToggle(
      (component) => component.setValue(!this.plugin.settings.disableSelectionMenu).onChange(async (value) => {
...
function loadCommands() {
  ...
  const generateCommand = (content) => {
    ...
    if (view) {
      ...
      const searchText = (_b = (_a = editLine.match(/[^\/]*$/)) == null ? void 0 : _a[0]) != null ? _b : "";
...
var isLineEdit = (el) => {
  return !!(el == null ? void 0 : el.querySelector(".cm-active:not(.HyperMD-codeblock)"));
};
var isLineSelect = (el) => {
  const arr = Array.from(el.classList);
  return !arr.find((e) => e.endsWith("codeblock") || e.endsWith("inline-title"));
};

// main.ts
var { isMobile } = import_obsidian7.Platform;
...
${codeStr}`,
    ...
    this.registerDomEvent(document, "mouseup", (evt) => {
      if (!isLineSelect(evt == null ? void 0 : evt.target))
        return;
      if (this.settings.disableSelectionMenu)
        return;
      handleSelection();
    });
    this.registerDomEvent(document, "keydown", (evt) => {
      var _a, _b, _c;
      if ((_c = (_b = (_a = evt == null ? void 0 : evt.target) == null ? void 0 : _a.getAttribute) == null ? void 0 : _b.call(_a, "class")) == null ? void 0 : _c.includes("command-option")) {
        const view = this.app.workspace.getActiveViewOfType(import_obsidian7.MarkdownView);
        if (view) {
          view.editor.focus();
        }
      ...
      if ((_a = this.commands) == null ? void 0 : _a.isVisible()) {
        ...
        if (key !== "ArrowUp" && key !== "ArrowDown" && key !== "ArrowLeft" && key !== "ArrowRight") {
          ...
          if (view) {
            const cursor = view.editor.getCursor();
            const editLine = view.editor.getLine(cursor.line);
            const _cmd = ((_b = editLine == null ? void 0 : editLine.match(/[^\/]*$/)) == null ? void 0 : _b[0]) || "";
            if (!editLine) {
              (_c = this.commands) == null ? void 0 : _c.hide();
            } else {
              (_d = this.commands) == null ? void 0 : _d.search(_cmd);
            }
            view.editor.focus();
          }
        }
      }
      (_e = this.btns) == null ? void 0 : _e.hide();
    });
    const renderPlugin = () => {
      var _a, _b, _c, _d, _e;
    ...
    this.registerDomEvent(document, "input", (evt) => {
      var _a;
      if (!isLineEdit(evt == null ? void 0 : evt.target))
        return;
